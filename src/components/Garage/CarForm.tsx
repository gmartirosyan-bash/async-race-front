  ...
  return (
    <>
      <form
        ...
        className="flex sm:flex-row flex-col items-center font-orbitron"
      >
        <div className="flex">
        ...
        <button
          type="submit"
          className="font-semibold sm:mt-0 mt-4 bg-red-800 px-4 py-2 active:scale-95 rounded hover:bg-red-900 hover:cursor-pointer active:bg-red-700"
        >
